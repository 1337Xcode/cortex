...
function measureWidths(el: HTMLElement, texts: string[]) {
  ...
  const widths = texts.map((t) => {
    ghost.textContent = t
    // Small buffer so overflow:hidden sweep does not clip glyphs at edges
    return ghost.getBoundingClientRect().width + 12
  })
  ghost.remove()
  return widths
}
    ...
    <motion.span
      ...
      style={{
        ...
        ...(isMulti && {
          ...
          flexShrink: 0,
          ...(fixedW != null && { width: fixedW, minWidth: fixedW }),
        }),
      }}
